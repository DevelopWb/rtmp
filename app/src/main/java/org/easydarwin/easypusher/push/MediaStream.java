...
//    }
    ...
    public void initConsumer(int width, int height) {
...
//        }
     ...
     *
     */
    private void stopCameraAudioVedio() {
        // 关闭音频采集和音频编码器
        if (audioStream != null) {
...
//    };
    ...
    public void onUvcCameraPreviewFrame(byte[] data,int uvcWidth,int uvcHeight) {
        if (data == null)
            return;
