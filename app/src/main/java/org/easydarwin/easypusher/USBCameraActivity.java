...
public class USBCameraActivity extends AppCompatActivity implements CameraDialog.CameraDialogParent, CameraViewInterface.Callback {
    ...
    private LinearLayout mLlayoutContrast;
    private SeekBar mSeekbarBrightness;
    private LinearLayout mLlayoutBrightness;
    /**
     * closeVoice
     */
    private Switch mSwitchRecVoice;
    ...
    private void initView() {
        ...
        mCameraView = (UVCCameraTextureView) findViewById(R.id.camera_view);
        mSeekbarContrast = (SeekBar) findViewById(R.id.seekbar_contrast);
        mLlayoutContrast = (LinearLayout) findViewById(R.id.llayout_contrast);
        mSeekbarBrightness = (SeekBar) findViewById(R.id.seekbar_brightness);
        mLlayoutBrightness = (LinearLayout) findViewById(R.id.llayout_brightness);
        mSwitchRecVoice = (Switch) findViewById(R.id.switch_rec_voice);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_takepic:
                ...
                String picPath = UVCCameraHelper.ROOT_PATH + PublicUtil.DIRECTORY_NAME + "/images/"
...
//                    FileUtils.createfile(FileUtils.ROOT_PATH + "test666.h264");
                    ...
                    params.setVoiceClose(mSwitchRecVoice.isChecked());    // is close voice
                    ...
                    mSwitchRecVoice.setEnabled(false);
                } else {
                    FileUtils.releaseFile();
                    mCameraHelper.stopPusher();
                    showShortMsg("stop record...");
                    mSwitchRecVoice.setEnabled(true);
                }
                break;
